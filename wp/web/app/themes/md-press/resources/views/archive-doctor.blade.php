    ...
    <div class="max-w-6xl mx-auto px-6 py-20 relative z-10">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12">
        <h1
          ...
          Directorio de <span class="text-emerald-400">Especialistas Médicos</span>
        </h1>
        <p class="mt-4 text-base text-slate-400 leading-relaxed">
          Busca y conecta con el profesional ideal. Filtra por nombre o especialidad médica.
        </p>
      </div>
      ...
      <div id="medical-search-root">
        ...
        <div class="flex flex-col items-center justify-center py-20 text-slate-400">
          ...
          <p class="text-sm font-semibold tracking-wide">Cargando directorio de especialistas...</p>
        </div>
      </div>
